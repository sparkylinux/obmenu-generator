...
our $SCHEMA = [
    ...
    {begin_cat => ['Encryption', 'truecrypt']},
    ...
    {begin_cat => ['Malware', 'gnibbles']},
	{item => ['clamtk',        'ClamTK',      'clamtk']},
    {end_cat => undef},

    {begin_cat => ['Monitoring', 'htop']},
    ...
    {begin_cat => ['Passwords MS Windows', 'security-medium']},
	{item => ['remsu ophcrack',        'ophcrack',      '/usr/share/pixmaps/ophcrack.xpm']},
    {end_cat => undef},

    {begin_cat => ['Remote Desktop', 'folder-network']},
    ...
    {begin_cat => ['Terminal Emulators', 'terminal']},
    ...
    ### Help menu ###
    {sep => 'Help'},
    {begin_cat => ['Quick Help', 'help']},
	{begin_cat => ['Backup Help', 'luckybackup']},
	...
	{begin_cat => ['Encryption Help', 'truecrypt']},
	...
	{begin_cat => ['Malware Help', 'gnibbles']},
	...
	{begin_cat => ['Monitoring Help', 'htop']},
	...
	{begin_cat => ['Network Help', 'preferences-system-network']},
	    {item => ['x-terminal-emulator -e man smbclient',        'Samba Client',      'help-about']},
        {end_cat => undef},

	{begin_cat => ['Package Managers Help', 'package-manager-icon']},
	...
	{begin_cat => ['Passwords MS Windows Help', 'security-medium']},
	    {item => ['x-terminal-emulator -e man ophcrack',        'ophcrack',      'help-about']},
        {end_cat => undef},

	{begin_cat => ['Remote Desktop Help', 'folder-network']},
    ...
    ### Applications menu ###
    {sep => 'Applications'},
    {begin_cat => ['Accessories', 'gnome-menu']},
    ...
    {begin_cat => ['Multimedia', 'configure']},
    ...
    {begin_cat => ['Network', 'applications-internet']},
    ...
    {begin_cat => ['Office', 'applications-office']},
	{item => ['evince',        'Evince',      'evince.png']},
    {end_cat => undef},

    {begin_cat => ['Settings', 'applications-accessories']},
    ...
    {begin_cat => ['System', 'applications-system']},
